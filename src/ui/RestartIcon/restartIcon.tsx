...
interface RestartIconProps {
  /**
   * The size of the icon in pixels. By default is 20.
   */
  size?: number;
  /**
...
export const RestartIcon = ({ size = 20, color = colors.semiDarkNavy }: RestartIconProps) => {
  return (
    <svg width={20} height={size} viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      <path
